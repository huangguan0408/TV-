...
$(document).ready(function() {
    ...
    if (so_so.indexOf('so=') > -1) {
        ...
        KLFM(G_Q_S('klfm'))
    } else if (so_so.match(/sgdj=/)) {var WNJP,time,url_s,url_p,jp_lb,lb_lb,lb_fy,pns,pn,mys,myx,myy,myld,myid,mymz,mysrc,mypng,myxo;
function MY_E2H(str) {
    var arrEntities = {'lt': '<','gt': '>','nbsp': ' ','amp': '&','quot': '"'};
    return str.replace(/&(lt|gt|nbsp|amp|quot);/ig, function(all, t) {
        return arrEntities[t];
...
function QQYYS_success_jsonpCallback(data, fy) {
    ...
    $.each(data, function(k, v) {
        ...
        if ((v.PNG).indexOf("GS@") > -1) {
            ...
            mymz = myx[3];
            if (mysrc === 'tbke') {
                lb_lb += '<li><a href="#MModal" onclick="javascript:' + myld + '(\'' + mymz + '__' + myid + '__' + mypng + '\');"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==" data-original="' + mypng + '" width="60" height="60" class="r r-2x img-full"></a><span class="glyphicon-class"><a href="#" class="text-ellipsis" title="' + mymz + '">' + mymz + '</a></span></li>'
            } else {
                lb_lb += '<li><a href="javascript:' + myld + '(\'' + myid + '\');" onclick="javascript:FX_ZYS(\'' + v.HTML + '@@@' + mypng + '\');"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==" data-original="' + mypng + '" width="60" height="60" class="r r-2x img-full"></a><span class="glyphicon-class"><a href="javascript:' + myld + '(\'' + myid + '\')" class="text-ellipsis" title="' + mymz + '">' + mymz + '</a></span></li>'
            }
        } else {
            lb_lb += '<li><a href="javascript:' + mysrc + '(\'' + v.HTML + '\');" onclick="javascript:FX_ZYS(\'' + v.HTML + '@@@' + mypng + '\');"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==" data-original="' + mypng + '" width="60" height="60" class="r r-2x img-full"></a><span class="glyphicon-class"><a href="javascript:' + mysrc + '(\'' + v.HTML + '\');" class="text-ellipsis" title="' + v.HTML + '">' + v.HTML + '</a></span></li>'
        }
    });
    lb_lb += '</ul></div>';
    if (fy.indexOf("&pg=") > -1) {
...
function kaolalists_success_jsonpCallback(data, lid, pn) {
    ...
    $.each(data.dataList, function(k, v) {
        ...
        lb_lb += '<li><a href="javascript:KLFM(\'' + v.id + '@1\');" onclick="javascript:FX_ZYS(\'KLFM@@@' + v.id + '@@@' + v.name + '@@@' + mypng + '\');"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==" data-original="' + mypng + '" width="60" height="60" class="r r-2x img-full"></a><span class="glyphicon-class"><a href="javascript:KLFM(\'' + v.id + '@1\');" class="text-ellipsis" title="' + v.name + '">' + v.name + '</a></span></li>'
    });
    lb_lb += '</ul></div>';
    if ((parseInt(pn) - 5) <= 0) {
        pns = 1
    ...
    $.ajax({
        ...
        success: function(jsonData) {
            ...
            $.each(datas, function(k, v) {
                ...
                lb_lb += '<li><a href="#MModal" onclick="javascript:KJ_PNG(\'' + v.url + '\');"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==" data-original="' + mypng + '" width="60" height="60" class="r r-2x img-full"></a><span class="glyphicon-class"><a href="#" class="text-ellipsis" title="' + mymz + '">' + mymz + '</a></span></li>'
            });
            lb_lb += '</ul></div>';
            pn = myid;
            if ((parseInt(pn) - 5) <= 0) {
    ...
    $.ajax({
        ...
        success: function(jsonData) {
            ...
            $.each(datas, function(k, v) {
                ...
                lb_lb += '<li><a href="#MModal" onclick="javascript:KJ_SGPNG(\'' + mypng + '\');"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==" data-original="' + mypng + '" width="60" height="60" class="r r-2x img-full"></a><span class="glyphicon-class"><a href="#" class="text-ellipsis" title="' + mymz + '">' + mymz + '</a></span></li>'
            });
            lb_lb += '</ul></div>';
            pn = myid;
            if ((parseInt(pn) - 5) <= 0) {
